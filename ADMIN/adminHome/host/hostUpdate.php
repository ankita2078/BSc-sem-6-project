...
<html lang="en">
  <head>
    ...
    <title>Admin Question Updating</title>
  </head>
  <body>
    ...
    <div class="container text-center justify-content-center align-items-center" >
        <form method="post">
            ...
            <div class="form-group">
                <label id="label" for="exampleFormControlTextarea1" name="question"><h3>QUESTION</h3></label>
                <textarea class="form-control" id="input" placeholder="Type your Question here" rows="3"></textarea>
            </div>
